Define el contrato del repositorio y la implementación concreta de persistencia.
...
- Definir token de inyección con `Symbol` en el archivo de contrato del repositorio:
