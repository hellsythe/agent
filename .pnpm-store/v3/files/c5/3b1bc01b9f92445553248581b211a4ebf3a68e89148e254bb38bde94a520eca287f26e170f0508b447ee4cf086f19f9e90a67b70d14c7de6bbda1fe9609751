...
const context_1 = require("./impact-metrics/context");
const metric_api_1 = require("./impact-metrics/metric-api");
...
const storage_provider_file_1 = __importDefault(require("./repository/storage-provider-file"));
const strategy_1 = require("./strategy");
Object.defineProperty(exports, "Strategy", { enumerable: true, get: function () { return strategy_1.Strategy; } });
const uuidv4_1 = require("./uuidv4");
const variant_1 = require("./variant");
const BACKUP_PATH = (0, node_os_1.tmpdir)();
        ...
        if (this.ready) {
            ...
            variant =
                typeof fallbackVariant !== 'undefined'
                    ...
                    : { ...variant_1.defaultVariant, featureEnabled: variant_1.defaultVariant.feature_enabled ?? false };
